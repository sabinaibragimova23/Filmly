...
movies = [
    ...
    {"title": "Mad Max: Fury Road", "description": "In a post-apocalyptic wasteland, Max teams up with Furiosa to flee from a cult leader and his army in a high-speed chase across the desert.", "genre": "Action", "year": 2015, "poster_url": "https://image.tmdb.org/t/p/w500/8tZYtuWezp8JbcsvHfdFeoE9Key.jpg"},
    ...
    {"title": "2001: A Space Odyssey", "description": "After discovering a mysterious artifact buried beneath the Lunar surface, mankind sets off on a quest to find its origins with the help of AI.", "genre": "Sci-Fi", "year": 1968, "poster_url": "https://image.tmdb.org/t/p/w500/ve72VxNqsuTFBRjQ4JfQvkUBMmd.jpg"},
    # Drama
    ...
    {"title": "The Green Mile", "description": "The lives of guards on Death Row are affected by one of their charges: a gentle giant with a mysterious gift and a horrifying fate.", "genre": "Drama", "year": 1999, "poster_url": "https://image.tmdb.org/t/p/w500/velWPhVocsvBW9enQEjMIGOhHkv.jpg"},
    # Crime
    ...
    {"title": "No Country for Old Men", "description": "Violence and mayhem ensue after a hunter stumbles upon a drug deal gone wrong and finds two million dollars near the Rio Grande.", "genre": "Crime", "year": 2007, "poster_url": "https://image.tmdb.org/t/p/w500/6dyRBDzaEqFT1aYPxFSHfQ4KDWM.jpg"},
    # Thriller
    ...
    {"title": "Prisoners", "description": "When two young girls go missing, a desperate father takes matters into his own hands as a detective races to find them.", "genre": "Thriller", "year": 2013, "poster_url": "https://image.tmdb.org/t/p/w500/iLBuMZMCNNkBRMFaOqJIL0NCFIV.jpg"},
    # Horror
    ...
    {"title": "Hereditary", "description": "A grieving family is haunted by tragic and increasingly disturbing occurrences after the death of their secretive grandmother.", "genre": "Horror", "year": 2018, "poster_url": "https://image.tmdb.org/t/p/w500/ob0R8fIPZnCsQVDO4LmEMTFPkD.jpg"},
    {"title": "Get Out", "description": "A young African American man visits his white girlfriend's parents for the weekend, where his concern about their intentions reaches a terrifying boiling point.", "genre": "Horror", "year": 2017, "poster_url": "https://image.tmdb.org/t/p/w500/qdziAVBTmRFMbOqJJWNjMBr9dne.jpg"},
    ...
    {"title": "The Wolf of Wall Street", "description": "Based on the true story of Jordan Belfort, from his rise to a wealthy stockbroker living the high life to his fall involving corruption and fraud.", "genre": "Comedy", "year": 2013, "poster_url": "https://image.tmdb.org/t/p/w500/sD9BKNXo3aLkmOVGXpXqR9ZZEZR.jpg"},
    ...
    {"title": "Before Sunrise", "description": "A young American man and a French woman meet on a train in Europe and disembark to spend one magical night together in Vienna.", "genre": "Romance", "year": 1995, "poster_url": "https://image.tmdb.org/t/p/w500/visnazbTnHRCPHMfNEa7CFOsM3x.jpg"},
    # Animation
    ...
    {"title": "The Revenant", "description": "A frontiersman on a fur trading expedition in the 1820s fights for survival after being mauled by a bear and left for dead by members of his own hunting team.", "genre": "Adventure", "year": 2015, "poster_url": "https://image.tmdb.org/t/p/w500/ji3ecJphATlVgWNY0B0RVXZizdn.jpg"},
    # Biography
